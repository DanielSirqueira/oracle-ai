...
- [vision.md](vision.md) — the concept (the "LLM Wiki" idea), the problem, the five pillars, and the core
  design decisions.
- [architecture.md](architecture.md) — Clean Architecture + DDD layering, the workspace packages, the nine
...
- [mcp-tools.md](mcp-tools.md) — the 29 MCP tools, grouped by domain, with their arguments.
