...
/// project, resolving product→project inheritance (project rules override
/// product rules with the same key).
class RulesForTaskQuery {
  /// Project the task runs in (its product's rules are inherited).
