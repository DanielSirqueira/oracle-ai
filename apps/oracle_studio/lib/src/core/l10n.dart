...
const _pt = <String, String>{
  ...
  'mod.intro': 'Módulos do projeto (auto-resolvidos pela subpasta). Reclassifique um "projeto falso" como módulo aqui.',
  'mod.empty': 'Nenhum módulo ainda. Os agentes criam via oracle_module_resolve, ou reclassifique um projeto.',
  'mod.reclassify': 'Reclassificar projeto',
  'mod.reclassifyTitle': 'Reclassificar projeto como módulo',
  'mod.reclassifyDesc': 'Escolha um projeto que na verdade é um módulo de "{p}". Ele vira um módulo daqui, com regras/memórias/arquitetura/skills e histórico re-apontados; o projeto solto é removido.',
  ...
  'rfc.fieldTypeDesc': 'backend | frontend | fullstack | data | infra | generic.',
  'rfc.fieldSummary': 'Resumo',
  'rfc.fieldSummaryDesc': 'O substrato executável da versão 1. Aceita markdown. É o que vai para o recall semântico.',
  'rfc.titleRequired': 'O título é obrigatório.',
  'rfc.created': 'RFC aberta.',
  'rfc.selectOne': 'Selecione uma RFC.',
  'rfc.empty': 'Nenhuma RFC ainda. Crie uma aqui ou deixe os agentes abrirem via oracle_rfc_open.',
  'rfc.filterAll': 'Todas',
  'rfc.filterOpen': 'Abertas',
  'rfc.filterApproved': 'Aprovadas',
  'rfc.round': 'rodada',
  'rfc.readiness': 'Prontidão',
  'rfc.readinessDesc': 'O gate de conclusão em resumo: bloqueadores verificados + cobertura obrigatória.',
  'rfc.ready': 'pronta',
  ...
  'rfc.finalizeMsg': 'passará pelo gate de conclusão (bloqueadores + cobertura) antes de aprovar.',
  'rfc.finalized': 'RFC',
...
const _en = <String, String>{
  ...
  'mod.intro': 'Project modules (auto-resolved from the subpath). Reclassify a "fake project" as a module here.',
  'mod.empty': 'No modules yet. Agents create them via oracle_module_resolve, or reclassify a project.',
  'mod.reclassify': 'Reclassify project',
  'mod.reclassifyTitle': 'Reclassify project as a module',
  'mod.reclassifyDesc': 'Pick a project that is really a module of "{p}". It becomes a module here, with its rules/memories/architecture/skills and history re-pointed; the stray project is removed.',
  ...
  'rfc.fieldSummaryDesc': "Version 1's executable substrate. Markdown supported. This is what goes to semantic recall.",
  'rfc.titleRequired': 'Title is required.',
  'rfc.created': 'RFC opened.',
  'rfc.selectOne': 'Select an RFC.',
  'rfc.empty': 'No RFCs yet. Create one here or let agents open one via oracle_rfc_open.',
  'rfc.filterAll': 'All',
  'rfc.filterOpen': 'Open',
  'rfc.filterApproved': 'Approved',
  'rfc.round': 'round',
  'rfc.readiness': 'Readiness',
  'rfc.readinessDesc': 'The termination gate at a glance: verified blockers + required coverage.',
  'rfc.ready': 'ready',
  ...
  'rfc.finalizeMsg': 'goes through the termination gate (blockers + coverage) before approval.',
  'rfc.finalized': 'RFC',
