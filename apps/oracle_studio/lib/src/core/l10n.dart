...
const _pt = <String, String>{
  ...
  'dup.intro': 'Memórias quase idênticas agrupadas por proximidade de embedding. Mantenha uma e aposente as demais.',
...
const _en = <String, String>{
  ...
  'dup.intro': 'Near-identical memories grouped by embedding proximity. Keep one and retire the rest.',
  'dup.rescan': 'Rescan',
