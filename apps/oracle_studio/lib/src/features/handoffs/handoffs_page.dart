  ...
  Widget build(BuildContext context) {
    ...
    return AsyncView<List<HandoffEntity>>(
      ...
      builder: (context, handoffs) {
        if (handoffs.isEmpty) {
          return Center(child: Text(l10n.t('handoff.empty')));
        }
        return MasterDetail(
          master: ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              return ListTile(
                ...
                title: Text(_firstLine(h.summary.value),
...
class _HandoffDetail extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final agents = [handoff.fromAgent, handoff.toAgent].whereType<String>().toList();
    return ListView(
      padding: const EdgeInsets.all(20),
      children: [
        Text(l10n.t('handoff.contextTitle'), style: Theme.of(context).textTheme.titleLarge),
        ...
        Wrap(
          ...
          children: [
            ...
            if (handoff.acceptedAt != null)
              MetaChip('${l10n.t('handoff.accepted')}: ${fmtDateTime(handoff.acceptedAt)}',
                  icon: Icons.done_all),
        ...
        _BulletSection(l10n.t('handoff.nextSteps'), handoff.nextSteps, Icons.checklist),
        _BulletSection(
            l10n.t('handoff.openQuestions'), handoff.openQuestions, Icons.help_outline),
        _BulletSection(
            l10n.t('handoff.filesTouched'), handoff.filesTouched, Icons.description_outlined),
      ],
    );
  }
}
